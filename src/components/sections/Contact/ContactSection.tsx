  ...
  return (
    <section id="contact" className="bg-white py-16 md:py-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
            ...
            Have questions or want to learn more about Alpha Omega? Get in touch with us!
            </p>
        </div>
        <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <h3 className="mb-4 text-xl font-bold">Meeting Times</h3>
                ...
                <div className="flex justify-between">
                    <span className="font-medium">Chapter Meeting</span>
                    <span className="text-muted-foreground text-gray-600">Mondays, 6:00 PM</span>
                </div>
                <div className="flex justify-between">
                    <span className="font-medium">Prayer Breakfast</span>
