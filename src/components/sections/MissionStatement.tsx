...
export default function MissionStatement() {
  return (
    <section id="mission" className="bg-black py-16 md:py-24">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
            ...
            <p className="mb-6 text-muted-foreground text-gray-300">
                Alpha Omega exists to develop men of integrity, faith, and leadership through brotherhood and service.
